        ...
        <Container className="serverSideContainer" fluid>
          <div className="serverSideView">
            <div className="retrospectiveTitleContainer">
              <h2 className="retrospectiveTitle">Retrospective</h2>
            </div>

            <Row>
              <Col className="retrospectiveGridItem">
              ...
              <Col className="retrospectiveGridItem">
                <div className="retrospectiveItemContainer">
                  ...
                  <div className="restAPIContainer">
                    <p className="restAPIText">
                      The part I found most challenging was implementing server
                      side authentication and security. This is a subject I plan
                      to prioritise more in my current studies
                    </p>
                  </div>
                </div>
              </Col>
